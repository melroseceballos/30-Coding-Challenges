 ...
 const arr1 = [1, 2, 3];
const result1 = mapArray(arr1, n => n * 2);
console.log(result1);

const arr2 = ['rose', 'tulip', 'daisy'];
const result2 = mapArray(arr2, (f, i) => `${i + 1} - ${f}`);
console.log(result2); // expected output: ["1 - rose", "2 - tulip", "3 - daisy"]
